...
export const ARCHETYPES: Archetype[] = [
  ...
  },
  {
    ...
    imageAvoidNotes: 'NEVER include people, pitmasters, or customers. NEVER render menu boards or text overlays. For brisket, only show clearly sliced smoked beef brisket with smoke ring, bark, fat cap and visible grain; never show bolar blade, chuck roast, generic roast beef, raw slabs, steaks, or ambiguous meat cuts. For general BBQ posts, prefer smoker/firebox/wood/sauce/tongs scenes over close-up unidentified meat.',
