...
const clerkAppearance = {
  elements: {
    ...
    socialButtonsBlockButton: 'bg-white/5 border border-white/10 text-white hover:bg-white/10 transition rounded-xl',
    socialButtonsBlockButtonText: 'text-white font-semibold',
    socialButtonsBlockButtonArrow: 'text-white/40',
    dividerLine: 'bg-white/10',
    dividerText: 'text-white/20 text-xs',
    formFieldLabel: 'text-white/50 text-xs font-semibold',
    formFieldInput: 'bg-black/40 border border-white/10 rounded-xl text-white text-sm placeholder:text-white/20 focus:border-amber-500/40',
    ...
    otpCodeFieldInput: 'bg-black/40 border border-white/10 rounded-xl text-white',
    alertText: 'text-red-400',
    alertIcon: 'text-red-400',
    badge: 'text-white/20',
    alternativeMethodsBlockButton: 'bg-white/5 border border-white/10 text-white hover:bg-white/10 transition rounded-xl',
    alternativeMethodsBlockButtonText: 'text-white/70',
    backLink: 'text-white/40 hover:text-white/70',
    formHeaderTitle: 'text-white',
    formHeaderSubtitle: 'text-white/30',
    selectButton: 'bg-black/40 border border-white/10 text-white rounded-xl',
    selectOptionsContainer: 'bg-[#111] border border-white/10 rounded-xl',
