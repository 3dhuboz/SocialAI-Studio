  ...
  it('requires every major Customer Learning Brain safety subsystem', () => {
    expect(REQUIRED_RELEASE_PROOF_CHECKS.map((check) => check.id)).toEqual(
      expect.arrayContaining([
        ...
        'independent_video_manifest_critic',
        ...
        'pilot_media_schema_and_egress',
        'pilot_media_bounded_generation',
        'pilot_media_single_active_lease',
        'pilot_media_provider_poll_contract',
        'pilot_media_image_usage_attribution',
        'pilot_media_video_post_boundary',
        'pilot_media_route_gates',
        'pilot_media_route_malformed_zero_spend',
        'pilot_media_withdrawal_fail_closed',
        'pilot_media_account_deletion_post_first',
        'pilot_cron_staging_isolation',
        'pilot_production_zero_d1',
        ...
        'pilot_positive_sample_preview_required',
        'pilot_positive_sample_preview_stale',
        'pilot_positive_sample_content_bounds',
        ...
        'readiness_deferred_schema_receipt',
        ...
        'calibration_production_zero_d1',
        ...
        'deferred_schema_deletion_compatibility',
        ...
        'egress_record_only_media_job_permanent_block',
        'egress_manual_path',
        'egress_cron_path',
