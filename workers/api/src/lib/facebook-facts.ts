...
// shop_domain into shopify_facts (schema_v24 — renamed v33 in this branch)
// rather than the (user_id, client_id)-keyed client_facts table. Same
// about/posts/photos scrape set — comments/events skipped here, mirroring
// the lighter onboarding-magic flow.
//
...
// the schema migration hasn't run yet), returning null instead of throwing —
// autopilot generation must keep working with or without facts.
