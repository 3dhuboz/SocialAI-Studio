...
import type { Env, D1Database } from './env';
...
// LLM hallucinates a scene. The image-gen pipeline (this file) was archetype-
// blind: it just took whatever `image_prompt` was stored and shipped it.
//
...
const ARCHETYPE_IMAGE_GUARDRAILS: Record<string, {
  forbidden: RegExp;
...
function applyArchetypeGuardrails(
